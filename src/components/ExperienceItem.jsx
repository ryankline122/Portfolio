...
function ExperienceItem({year, title, company, duration, location, details}){

    return (
        <ol className="flex flex-col md-flex-row relative border-1 
        border-stone-200 items-center justify-center ">
            <li className="mb-10 ml-4">
                ...
                mt-1.5-left-1.5 border border-white " /> */}
                    ...
                    items-center justify-start text-xs md:text-sm">
                        ...
                        <h3 className="text-lg font-semibold text-stone-900">{title} | {company} | {location}</h3>
